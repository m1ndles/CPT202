...
public class CommentReportRepository {
    ...
    /**
     * Returns a comment report thread by id.
     */
    ...
    /**
     * Returns the existing report thread opened by a user for one comment.
     */
    ...
    /**
     * Returns every comment report thread for the admin complaint inbox.
     */
    ...
    /**
     * Creates a new comment report thread and returns its generated id.
     */
    ...
    /**
     * Updates the moderation status and last-updated time of a report thread.
     */
    ...
    /**
     * Returns all messages inside a comment report thread.
     */
    ...
    /**
     * Inserts a message into a comment report thread.
     */
    ...
    /**
     * Immutable comment report thread view used by services.
     *
     * @param id report thread id
     * @param commentId reported comment id
     * @param reporterUserId reporting user id
     * @param reporterName reporting user display name
     * @param status moderation status
     * @param createdAt thread creation time
     * @param updatedAt latest update time
     * @param resourceId resource containing the comment
     * @param commentContent reported comment content
     * @param commentAuthor reported comment author
     * @param resourceTitle related resource title
     * @param resourceStatus related resource status
     */
