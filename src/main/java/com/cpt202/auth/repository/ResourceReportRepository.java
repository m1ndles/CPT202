...
public class ResourceReportRepository {
    ...
    /**
     * Returns a resource report thread by id.
     */
    ...
    /**
     * Returns the existing report thread opened by a user for one resource.
     */
    ...
    /**
     * Returns every resource report thread for the admin complaint inbox.
     */
    ...
    /**
     * Creates a new resource report thread and returns its generated id.
     */
    ...
    /**
     * Returns all messages inside a resource report thread.
     */
    ...
    /**
     * Inserts a message into a resource report thread.
     */
    ...
    /**
     * Immutable resource report thread view used by services.
     *
     * @param id report thread id
     * @param resourceId reported resource id
     ...
     * @param resourceTitle reported resource title
     * @param resourceStatus reported resource status
     * @param ownerUsername resource owner username
     */
